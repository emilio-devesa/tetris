...
public class JTetromino extends Tetromino {
    ...
    /**
     * Constructs a J-tetromino at the given position with specified rotation.
     *
     * @param position       the top-left corner of the bounding box
     * @param rotationState  the rotation state (0-3)
     */
    public JTetromino(Point position, int rotationState) {
        super(position, rotationState, Type.J);
    }

    /**
     * Constructs a J-tetromino at the given position with rotation 0.
     *
     * @param position the top-left corner of the bounding box
     */
    ...
    public Tetromino moveTo(Point newPosition) {
        return new JTetromino(newPosition, rotationState);
    }

    @Override
    public Tetromino rotateClockwise() {
        return new JTetromino(position, (rotationState + 1) % 4);
    }
}